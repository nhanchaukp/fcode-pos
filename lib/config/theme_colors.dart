...
const _defaultColors = AppColors(
  ...
  onSuccess: Color(0xFFffffff), // green-600
  info: Color(0xFF0284c7),
  onInfo: Color(0xFFffffff), // sky-600
  warning: Color(0xFFf59e0b),
  onWarning: Color(0xFF0f172a), // amber-500 / slate-900
  danger: Color(0xFFdc2626),
  onDanger: Color(0xFFffffff), // red-600
);
...
const _industrialColors = AppColors(
  ...
  onSuccess: Color(0xFFffffff), // green-600
  info: Color(0xFF0284c7),
  onInfo: Color(0xFFf1f5f9), // sky-600 / slate-100
  warning: Color(0xFFf59e0b),
  onWarning: Color(0xFF0f172a), // amber-500 / slate-900
  danger: Color(0xFFdc2626),
  onDanger: Color(0xFFf1f5f9), // red-600 / slate-100
);

// Pastel: soft pastel semantic colors
const _pastelColors = AppColors(
  success: Color(0xFF86efac),
  onSuccess: Color(0xFF166534), // green-300 / green-800
  info: Color(0xFF93c5fd),
  onInfo: Color(0xFF075985), // blue-300 / sky-800
  warning: Color(0xFFfcd34d),
  onWarning: Color(0xFFb45309), // amber-300 / amber-700
  danger: Color(0xFFfca5a5),
  onDanger: Color(0xFF991b1b), // red-300 / red-800
);
...
const _arcticColors = AppColors(
  ...
  onInfo: Color(0xFFffffff), // sky-600
  warning: Color(0xFFf59e0b),
  onWarning: Color(0xFFffffff), // amber-500
  danger: Color(0xFFdc2626),
  onDanger: Color(0xFFffffff), // red-600
);
...
const _highContrastColors = AppColors(
  ...
  onSuccess: Color(0xFF000000), // green-500
  info: Color(0xFF0ea5e9),
  onInfo: Color(0xFF000000), // sky-500
  warning: Color(0xFFeab308),
  onWarning: Color(0xFF000000), // yellow-500
